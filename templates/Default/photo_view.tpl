...
<div class="photo_close" onClick="Photo.Close('{close-link}'); return false;"></div>
 <div class="photo_bg">
  ...
  <div class="photo_leftcol">
   ...
   <!--likes--><div style="margin-top:-12px"></div>
   <div class="fl_r public_photo_like cursor_pointer" id="photos_likes_but{id}" onClick="Photo.{likes-func}({id})" style="width:{likes-width}">
   <span><div class="fl_l" id="wall_like_active">Мне нравится</div></span>
   <div class="public_wall_like_no {yes-like}"></div>
   <b id="photos_like_{id}" class="color:#a1c4e4">{likes-num}</b>
  </div>
  <!--/likes--><br />
  ...
  <div class="photo_rightcol">
   ...
   <a href="/" onClick="Photo.EditBox({id}, 0); return false"><div>Редактировать фотографию</div></a>
   <a href="/" onClick="Photo.MsgDelete({id}, {aid}, 1); return false"><div>Удалить фотографию</div></a>[/owner]
   <a onClick="Report.Box('photo', '{id}')"><div>Пожаловаться на фотаграфию</div></a>
