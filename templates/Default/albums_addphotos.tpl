...
<div class="sft" style="margin-top:-6px">
 ...
 <div class="buttonsprofileSec2"><a href="/albums/add/{aid}" onClick="Page.Go(this.href); return false;"><div>Добавление фотографий</div></a></div>
</div></div>
<br>
<br>
<div class="clear"></div>
...
<span id="photos"></span>
<div class="clear"></div>
<div class="load_photo_but" style="margin-left:150px;">
<div class="fl_l">
