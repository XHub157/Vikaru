...
<small>Файл не должен превышать 5 Mб. Если у Вас возникают проблемы с загрузкой, попробуйте использовать фотографию меньшего размера.<br>
Если Ваш компьютер оснащен веб-камерой, Вы можете <a href="/" onClick="Profile.webcam(); $('.profileMenu').hide(); return false;">сделать моментальную фотографию »</a></small>
</div>