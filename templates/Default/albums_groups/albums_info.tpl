...
<div class="info_center">Пока нет ни одного фотоальбома.
[owner]<br>Вы можете попробовать создать <a onClick="AlbumsGroups.CreatAlbum(); return false;">новый альбом</a>.[/owner]</div>
