...
<div id="page_body" style="width: 641px;margin-top:-5px;margin-left:-12px;height:216px">
  ...
  <div id="wrap1">
    <div id="content"><div class="app_edit_summary">Создание приложения
	<span class="divider">|</span>
	<a href="/dev">Перейти к документации</a>
</div>
...
<div id="apps_edit_iframe_options" style="display: none;">
  ...
  <tr><td class="label ta_r">Категория:</td><td><div class="box_dark apps_edit_dd"><input class="text" type="hidden" id="app_subcategory"/></div></td></tr>
...
<tr><td class="label ta_r"></td><td>
  <div class="button_blue"><button id="apps_create_app_btn" onclick="AppsEdit.CreateApp(this);">Подключить приложение</button></div>
</td></tr>
</table>
