var AppsEdit = {
	...
	SaveOptions: function (type,id) {
			...
			$.post('/index.php?go=editapp&act='+type, {app_title: app_name, app_desk: app_desk, app: id, app_status: app_status, app_url: app_url, app_width: app_width, app_height: app_height, app_type: app_type}, function(data){
