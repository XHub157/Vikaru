...
$(document).ready(function(){
	...
	$("#saveform").click(function(){
		...
		$.post('/index.php?go=editprofile&act=save_general', {name: name, lastname: lastname, dev: dev, otcestvo: otcestvo, roditeli: roditeli, bratiasestry: bratiasestry, rodgorod: rodgorod, babushkadedushka: babushkadedushka, deti: deti, vnuki: vnuki, lange: lange, sex: sex, day: day, month: month, year: year, country: country, city: city, sp: sp, sp_val: sp_val, dprivacy: dprivacy}, function(data){
			$('#info_save').hide();
			if(data == 'ok'){
				$('#info_save').show();
