...
var reg = {
	...
	step2: function(){
		...
		$('#step3').show("slow");
			...
			setErrorInputMsg('select_city');
					$('#erri').show("fast").html('Укажите свой город.');
			}
		} else {
			setErrorInputMsg('country');
					$('#erri').show("fast").html('Укажите свою страну.');
		}		} else {
			setErrorInputMsg('sex');
					$('#erri').show("fast").html('Выберите пол.');
			}
	},
	finish: function(){
		var email = $('#email').val();
