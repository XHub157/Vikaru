...
<div class="sft" style="margin-top:-6px">
 <div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond2" style="height:15px">
  <a href="/clubs" onClick="Page.Go(this.href); return false;"><div>Сообщества</div></a>
  <div class="buttonsprofileSec2"><a href="/clubs?act=admin" onClick="Page.Go(this.href); return false;"><div>Управление</div></a></div>
 </div>
</div>
