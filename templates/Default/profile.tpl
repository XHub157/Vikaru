<div style="margin-left:110px"><div class="news_wall_msg_bg no_display" id="wall_text_250" style="width:300px;font-weight: normal;margin-top:-4px;">
 <div class="news_wall_msg_text" ><b><a href="/verify" onclick="page.go(this.href)">Подтвержденная страница</a></b><br><div class="mgclr"></div>Данная отметка означает, что страница пользователя была подтверждена администрацией WebMaster.pp.ua<div class="clear"></div></div></div></div>
...
[owner]
<a href="/edit" onClick="Page.Go(this.href); $('.profileMenu').hide(); return false;"><div>Редактировать страницу</div></a>
<div class="more_div2"></div>
[gifts]<a class="fans" href="/gifts{user-id}" ><div style="text-align:left;"> Мои подарки <small style="float:right;color: #60878E;"><b>{gifts-text}<span class="fl_r profile_gifts"></span></b></small></div></a>[/gifts]
...
[not-owner]<div class="profile_subscblock">
   ...
   <div class="clear"></div>[/blacklist][/no-friends]
    [yes-friends]<div id="friend_status"><div class="friend_status_info" onMouseOver="myhtml.title('{user-id}', '{name} доступны все Ваши материалы,<br>предназначенные для друзей. <br><b></b>', 'happy_user_', 5)" id="happy_user_{user-id}">{name} у Вас в друзьях</div></div>
...
[privacy-gift][gifts]<a class="fans" href="/gifts{user-id}"><div style="text-align:left;">Подарки {name2}<small style="float:right;color: #60878E;"><b>{gifts-text}<span class="fl_r profile_gifts"></span></b></small></div></a>[/gifts][/privacy-gift]
...
[blacklist]<div class="leftcbor">
 [privacy-gift][gifts]<div class="albtitle cursor_pointer" >{gifts-text2}[not-owner]<span class="fl_r profile_gifts"></span>[/not-owner]</div>
 <div class="newmesnobg" style="padding:0px"><center><a href="/gifts{user-id}" >{gifts}</a></center><div class="clear"></div>
 ...
 [online-friends]<div class="albtitle cursor_pointer" onclick="Page.Go('/friends/online/{user-id}')">Друзья онлайн</div>
...
<div class="profiewr">
 ...
 [privacy-info][not-block-contact]<div class="fieldset"><div class="w2_a" [owner]style="width:230px;"[/owner]>Контактная информация [owner]<span><a href="/edit&act=contact" onClick="Page.Go(this.href); return false;">редактировать</a></span>[/owner]</div></div>
 ...
 <div class="fieldset"><div class="w2_b" [owner]style="width:200px;"[/owner]>Личная информация [owner]<span><a href="/edit&act=interests" onClick="Page.Go(this.href); return false;">редактировать</a></span>[/owner]</div></div>{not-block-info}
...
[career]<div class="fieldset"><div class="w2_b" [owner]style="width:200px;"[/owner]>Карьера [owner]<span><a href="/edit&act=career" onClick="Page.Go(this.href); return false;">редактировать</a></span>[/owner]</div></div> 
 ...
 <a style="text-decoration: none;" href="/albums{user-id}" onclick="Page.Go(this.href); return false"><div class="albtitle" style="margin-top:5px">Фотографии[owner]<span class="fl_r" id="wall_rec_num">добавить фотографии</span>[/owner]</div></a>
 ...
 [privacy-wall]<div class="newmes" id="wall_tab" style="border-bottom:0px;margin-bottom:-5px">
  ...
  <div class="no_display" id="wall_textarea">
   ...
   <div class="wall_attach_menu no_display" onMouseOver="wall.attach_menu('open', 'wall_attach', 'wall_attach_menu')" onMouseOut="wall.attach_menu('close', 'wall_attach', 'wall_attach_menu')" id="wall_attach_menu">
    ...
    <div class="wall_attach_icon_graffity" id="wall_attach_link" onClick="wall.attach_addgraffiti('{user-id}')">Граффити</div>
