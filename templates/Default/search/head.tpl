...
maxlength="65" />
<div class="button_blue fl_r"><button onClick="gSearch.go(); return false">Поиск</button></div>
<div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond" style="margin-top:10px;height:22px">
 ...
 [search-tab]<div class="{activetab-4}"><a href="/?go=search{query-groups}" onClick="Page.Go(this.href); return false;"><div><b>Сообщества</b></div></a></div>[/search-tab]
 [search-tabg]<div class="{activetab-4}"><a href="/?go=search{query-groups}" onClick="Page.Go(this.href); return false;"><div><b>Сообщества</b></div></a></div>[/search-tabg]
 [search-tabv]<div class="{activetab-4}"><a href="/?go=search{query-groups}" onClick="Page.Go(this.href); return false;"><div><b>Сообщества</b></div></a></div>[/search-tabv]
 [search-taba]<div class="{activetab-4}"><a href="/?go=search{query-groups}" onClick="Page.Go(this.href); return false;"><div><b>Сообщества</b></div></a></div>[/search-taba]

 [search-tabc]<div class="{activetab-6}"><a href="/?go=search{query-clubs}" onClick="Page.Go(this.href); return false;"><div><b>Сообщества</b></div></a></div>[/search-tabc]
...
[search-tab]<div class="search_sotrt_tab">
 ...
 <div class="html_checkbox" id="online" onClick="myhtml.checkbox(this.id); gSearch.go();" style="color: black">сейчас на сайте</div>
 <div class="html_checkbox" id="user_photo" onClick="myhtml.checkbox(this.id); gSearch.go();" style="margin-top:9px;color: black">с фотографией</div>
...
<div class="search_sotrt_tab">
 <b>Тип сообщества</b>
 <div class="search_clear"></div>
 <div class="padstylej"><input type="radio" checked="" id="club" name="type" onclick="Page.Go('/?go=search&type=6')"><label for="club" style="cursor:pointer">Группа</label></div>
<div class="mgclr"></div>
 <div class="padstylej"><input type="radio" id="public" name="type" onclick="Page.Go('/?go=search&type=4')"><label for="public" style="cursor:pointer">Страница</label></div>
</div>
[/search-tabc]
[search-tabg]
<div class="search_sotrt_tab">
 <b>Тип сообщества</b>
 <div class="search_clear"></div>
 <div class="padstylej"><input type="radio" id="club" name="type" onclick="Page.Go('/?go=search&type=6')"><label for="club" style="cursor:pointer">Группа</label></div>
<div class="mgclr"></div>
 <div class="padstylej"><input type="radio" checked="" id="public" name="type" onclick="Page.Go('/?go=search&type=4')"><label for="public" style="cursor:pointer">Страница</label></div>
</div>
[/search-tabg]
