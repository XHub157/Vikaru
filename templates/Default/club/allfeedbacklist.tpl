<div class="public_obefeed" id="f{user-id}" onMouseOver="ge('public_minilink{user-id}').style.opacity = '1'" onMouseOut="ge('public_minilink{user-id}').style.opacity = '0.4'">
 ...
 <a href="/u{user-id}" onClick="Page.Go(this.href); return false">{name}</a><div class="fl_r public_minilink" id="public_minilink{user-id}"><a href="/" onClick="messages.new_('{user-id}'); return false">Сообщение</a>[admin] &nbsp;-&nbsp; <a href="/club{id}" onClick="clubs.editfeedback('{user-id}'); return false">Редактировать</a> &nbsp;-&nbsp; <a href="/" onClick="clubs.delfeedback('{id}', '{user-id}'); return false">Удалить</a>[/admin]</div><br />
 ...
 [admin]<div id="editf{user-id}" class="no_display">
  ...
  <a href="/club{id}" style="margin-left:10px;font-size:11px;font-weight:normal" onClick="clubs.editfeeddave('{id}', '{user-id}'); return false">Сохранить</a>
 </div>[/admin]
 <div class="clear"></div>
</div>