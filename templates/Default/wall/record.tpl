...
<div><a href="/u{user-id}" onClick="Page.Go(this.href); return false">{name}</a></div>[owner]<div class="wall_delete no_display" style="margin-top:-15px" id="fast_del_{comm-id}" onClick="wall.fast_comm_del('{comm-id}'); return false"></div>[/owner]
