...
<div class="ewllfs"><a href="/u{author-id}"><img src="{ava}" width="40" height="40" align="left" /></a>{online}</div>
<div class="wallwTEXT">
<a href="/u{author-id}"><b>{author}</b></a> <span class="color777">{action-type-updates}</span><br />
<div>{comment}</div>
<div class="clr"></div>
...
[comments-link]<div id="fast_form_{rec-id}"><textarea class="wall_fast_text inp" style="height:33px;color:#000;margin:0px;margin-top:10px;width:300px;margin-bottom:10px" id="fast_text_{rec-id}" placeholder="Комментировать.."></textarea>
<div class="clr"></div>
...
[comment-form]<div style="margin-left:50px;margin-bottom:10px" id="fast_form_{rec-id}"><textarea class="wall_fast_text inp" style="height:33px;color:#000;margin:0px;margin-top:5px;width:305px;margin-bottom:10px" id="fast_text_{rec-id}" placeholder="Комментировать.."></textarea>
<div class="clr"></div>
