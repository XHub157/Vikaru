...
<div class="ads_set_hover fl_r" onClick="ads.edit_form('{id}')">Редактировать объявление</div><br />

</span>

<span id="edit_res_show_{id}" class="ads_title_editor" style="display:none;">Редактор рекламных ябявлнений</span>
...
<div class="button_div fl_l"><button onClick="ads.edit_save('{id}')">Сохранить</button></div>

<div class="button_div_gray margin_left_off" id="editClose"><button onClick="ads.edit_close('{id}')">Отмена</button></div>

<div class="button_div_gray margin_left_delet"><button onclick="ads.delete_ads('{id}');">Удалить обявление</button></div>
