...
<div id="Xjquery_jplayer"></div>
 ...
 <div class="staticPlbgTitle">
  ...
  <div class="staticpl_repeat" onClick="player.refresh()" id="xPlayerVolrefresh1"></div>
  <div class="staticpl_rand" onClick="player.rand()"  id="xPlayerRand1"></div>
  
  <div class="clear"></div>
 </div>
 <div class="staticpl_seachbg">
  <img src="/templates/Default/images/loading_mini.gif" class="fl_r no_display" id="jQpLoad" style="margin-left:410px;margin-top:13px;position:absolute" />
