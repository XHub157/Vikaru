...
function gram_record($num,$type){
	...
	if($type == 'dialog'){
		if($numres == 0){
			$gram_num_record = 'диалогов';
		} elseif($numres == 1){
			$gram_num_record = 'диалог';
		} elseif($numres < 5){
			$gram_num_record = 'диалога';
		} elseif($numres < 21){
			$gram_num_record = 'диалогов';
		} elseif($numres == 21){
			$gram_num_record = 'диалог';
	...
	if($type == 'friends_mutual'){
		if($numres == 0){
			$gram_num_record = 'нет общих друзей';
		} elseif($numres == 1){
			$gram_num_record = 'общий друг';
		} elseif($numres < 5){
			$gram_num_record = 'общих друга';
		} elseif($numres < 21){
			$gram_num_record = 'общих дурзей';
		} elseif($numres == 21){
			$gram_num_record = 'общий друг';
		}
	}
	...
	if($type == 'topics'){
		if($numres == 0){
			$gram_num_record = 'нет тем';
		} elseif($numres == 1){
			$gram_num_record = 'тема';
		} elseif($numres < 5){
			$gram_num_record = 'темы';
		} elseif($numres < 21){
			$gram_num_record = 'тем';
		} elseif($numres == 21){
			$gram_num_record = 'тема';
	...
	if($type == 'friends_online'){
		if($numres == 0){
			$gram_num_record = 'нет друзей на сайте';
		} elseif($numres == 1){
	...
	if($type == 'admins'){
		if($numres == 0){
			$gram_num_record = 'администраторов';
		} elseif($numres == 1){
			$gram_num_record = 'администратор';
		} elseif($numres < 5){
			$gram_num_record = 'администратора';
		} elseif($numres < 21){
			$gram_num_record = 'администраторов';
		} elseif($numres == 21){
			$gram_num_record = 'администраторов';
	...
	if($type == 'clubs'){
		if($numres == 1){
			$gram_num_record = 'группе';
		} elseif($numres < 5){
			$gram_num_record = 'группах';
		} elseif($numres < 21){
			$gram_num_record = 'группах';
		} elseif($numres == 21){
			$gram_num_record = 'группе';
	...
	if($type == 'public'){
		if($numres == 1){
			$gram_num_record = 'страница';
		} elseif($numres < 5){
			$gram_num_record = 'страницы';
		} elseif($numres < 21){
			$gram_num_record = 'страниц';
		} elseif($numres == 21){
			$gram_num_record = 'страница';
		}
	}
	...
	if($type == 'se_clubs'){
		if($numres == 1){
			$gram_num_record = 'группа';
		} elseif($numres < 5){
			$gram_num_record = 'группы';
		} elseif($numres < 21){
			$gram_num_record = 'групп';
		} elseif($numres == 21){
			$gram_num_record = 'группа';
		}
	}		
	...
	if($type == 'audio'){
		if($numres == 1){
			$gram_num_record = 'аудиозапись';
		} elseif($numres < 5){
			$gram_num_record = 'аудиозаписи';
		} elseif($numres < 21){
			$gram_num_record = 'аудиозаписей';
		} elseif($numres == 21){
			$gram_num_record = 'аудиозапись';
		}
	}
