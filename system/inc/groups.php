...
<font color="blue">Забаненые сообщества помечены синим цветом</font><br />
<font color="green">Официальные сообщества</font>
</div>
...
<select name="mass_type" class="inpu" style="width:260px">
 ...
 <option value="5">Подтвердить сообщество</option>
 <option value="6">Убрать подтвержение сообщества</option>
</select>
